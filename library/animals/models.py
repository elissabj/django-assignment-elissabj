...
class Animal(models.Model):
    ...
    verte_type = models.CharField(max_lenght=128)
    vital_function = models.CharField(max_lenght=128)
...
class Environment(models.Model):
    ...
    enviros = models.ManyToManyField(Animal, through='AnimalsEnvironment')
